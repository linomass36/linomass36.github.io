...
- Notes: *"High willingness, high reach — but very busy. Reminder that you're your mom's son lands well. Worth a light, specific ask."*
- **Standing opportunities:**
...
|---|---|---|---|
| **Case report** | 8–15 | 2–4 mo | Rawicz's standing offer. Cheapest real paper that exists |
...
- It gives the Rawicz relationship a concrete artifact rather than a coffee
...
What the annex buys: Polkowski (whom you owe), Rawicz, and a Kraków trip with a purpose. It buys nothing else, and it should not try to.
...
| 3 | Convert ONKO Kraków into an abstract deadline | 1 email to Rawicz | The only external forcing function on the board |
